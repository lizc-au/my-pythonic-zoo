"""
Lion implementation used by the Factory Pattern example.

Lion is a concrete animal class. It provides the ``speak()`` behaviour
...
class Lion:
    """
    Represent a lion satisfying this example's ``Animal`` contract.

    See ``factory.animals.animal.Animal`` for scope and related use cases.
    """

    def speak(self) -> None:
        """Display one sound made by this lion."""
        print("Roar!")
